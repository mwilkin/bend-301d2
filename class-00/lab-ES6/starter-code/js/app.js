...
function displayPics(){
  ...
  // The console.log(rando) threw an uncaught reference error because rando was scoped to the first while block in the function displayPics() and the console log was outside that bock of code. If the console log was inside the while block, no error would've been thrown.
  console.log(viewed);
